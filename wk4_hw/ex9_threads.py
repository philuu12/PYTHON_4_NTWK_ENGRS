...
"""
Assignmet 9:
Bonus Question - Redo exercise6 but have the SSH connections happen concurrently
using either threads or processes 
(see example: https://github.com/ktbyers/netmiko/blob/master/examples/multiprocess_example.py).
